...
# Потолок тела запроса (DATA_UPLOAD_MAX_MEMORY_SIZE в settings) рассчитан так,
# чтобы два вложения по MAX_ATTACHMENT_MB влезали в один запрос; менять одно без
# другого нельзя. Чек — фотография квитанции, ему хватает меньшего предела.
MAX_ATTACHMENT_MB = 7
MAX_RECEIPT_MB = 3
